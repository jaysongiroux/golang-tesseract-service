...
export default function TermsPage() {
  return (
    <div className="text-slate-50 scroll-smooth">
      <section className="py-20 md:py-24 h-full bg-slate-950 px-12 text-slate-50">
        <div className="container px-4">
          <h1 className="text-3xl font-bold text-slate-50 mb-4">
            TERMS OF SERVICE
          </h1>
          <p className="text-sm text-gray-500 mb-6">
            Last updated <span className="font-semibold">May 02, 2025</span>
          </p>
          ...
          <p className="text-slate-100 mb-4">
            We are <span className="font-semibold">Atlas OCR</span>{" "}
            (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot;
            &quot;our&quot;).
          </p>
          <p className="text-slate-100 mb-4">
            ...
            <a
              href="http://www.atlasocr.com"
              className="text-blue-500 hover:underline"
            >
              http://www.atlasocr.com
            </a>{" "}
          ...
          <p className="text-slate-100 mb-4">
            ...
            <a
              href="mailto:support@atlasocr.com"
              className="text-blue-500 hover:underline"
            >
              support@atlasocr.com
            </a>
          </p>
          <p className="text-slate-100 mb-4">
            ...
            (&quot;you&quot;), and{" "}
            <span className="font-semibold">Atlas OCR</span>, concerning your
          ...
          <ol className="list-decimal list-inside text-slate-100 mb-6">
            <li>OUR SERVICES</li>
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">1.</span> OUR SERVICES
          </h2>
          <p className="text-slate-100 mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">2.</span> INTELLECTUAL PROPERTY RIGHTS
          </h2>
          ...
          <p className="text-slate-100 mb-4">
            ...
            <span className="font-semibold">&quot;Content&quot;</span>), as well
          ...
          <p className="text-slate-100 mb-4">
            ...
            <span className="font-semibold">&quot;AS IS&quot;</span> for your{" "}
            <span className="font-semibold">
          ...
          <p className="text-slate-100 mb-4">
            ...
            revocable <span className="font-semibold">license</span> to:
          </p>
          <ul className="list-disc list-inside text-slate-100 mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">3.</span> USER REPRESENTATIONS
          </h2>
          <p className="text-slate-100 mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">4.</span> USER REGISTRATION
          </h2>
          <p className="text-slate-100 mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">5.</span> PURCHASES AND PAYMENT
          </h2>
          <p className="text-slate-100 mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">6.</span> SUBSCRIPTIONS
          </h2>
          <h3 className="text-lg font-semibold text-slate-50 mb-2">
            Billing and Renewal
          </h3>
          <p className="text-slate-100 mb-4">
            ...
            applicable order.&nbsp;The length of your billing
            cycle&nbsp;is&nbsp;monthly, pay for usage.
          </p>
          <h3 className="text-lg font-semibold text-slate-50 mb-2">
            Cancellation
          </h3>
          ...
          <ul className="list-disc list-inside text-slate-100 mb-6">
            <li>
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">8.</span> USER GENERATED CONTRIBUTIONS
          </h2>
          <p className="text-slate-100 mb-4">
          ...
          <ul className="list-decimal list-inside text-slate-100 mb-6">
            <li>
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">9.</span> CONTRIBUTION&nbsp;LICENSE
          </h2>
          <p className="text-slate-100 mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">10.</span> THIRD-PARTY WEBSITES AND
            CONTENT
          </h2>
          <p className="text-slate-100 mb-4">
            ...
            any&nbsp;Third-Party&nbsp;Content, you do so at your own risk, and
            ...
            on&nbsp;Third-Party&nbsp;Websites and you shall hold us blameless
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">11.</span> SERVICES MANAGEMENT
          </h2>
          <p className="text-slate-100 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">12.</span> PRIVACY POLICY
          </h2>
          <p className="text-slate-100 mb-4">
            We care about data privacy and security. Please review our Privacy
            Policy:&nbsp;
            <a
              href="http://www.atlasocr.com/legal/privacy"
              className="text-blue-500 hover:underline"
            >
              http://www.atlasocr.com/legal/privacy
            </a>
            . By using the Services, you agree to be bound by our Privacy
            Policy, which is incorporated into these Legal Terms. Please be
            advised the Services are hosted in&nbsp;the&nbsp;United States. If
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">13.</span> TERM AND TERMINATION
          </h2>
          <p className="text-slate-100 mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">14.</span> MODIFICATIONS AND
            INTERRUPTIONS
          </h2>
          <p className="text-slate-100 mb-4">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">15.</span> GOVERNING LAW
          </h2>
          <p className="text-slate-100 mb-6">
            These Legal Terms and your use of the Services are governed by and
            construed in accordance with the laws of&nbsp;the State
            of&nbsp;Wyoming&nbsp;applicable to agreements made and to be
            entirely performed within&nbsp;the State
            of&nbsp;Wyoming,&nbsp;without regard to its conflict of law
            principles.
          </p>

          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">16.</span> DISPUTE RESOLUTION
          </h2>
          <h3 className="text-lg font-semibold text-slate-50 mb-2">
            Binding Arbitration
          </h3>
          <p className="text-slate-100 mb-4">
            ...
            the arbitration will take place in&nbsp;Wyoming. Except as otherwise
          ...
          <p className="text-slate-100 mb-4">
            ...
            in&nbsp;Cheyenne,&nbsp;Wyoming, and the Parties hereby consent to,
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">18.</span> DISCLAIMER
          </h2>
          <p className="text-slate-100 mb-6">
            ...
            SERVICES&apos; CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THE
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">19.</span> LIMITATIONS OF LIABILITY
          </h2>
          <p className="text-slate-100 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">20.</span> INDEMNIFICATION
          </h2>
          <p className="text-slate-100 mb-6">
            ...
            your Contributions; (2) your use of the Services; (3) your breach of
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">21.</span> USER DATA
          </h2>
          <p className="text-slate-100 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">22.</span> ELECTRONIC COMMUNICATIONS,
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">23.</span> CALIFORNIA USERS AND
            RESIDENTS
          </h2>
          <p className="text-slate-100 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">24.</span> MISCELLANEOUS
          </h2>
          <p className="text-slate-100 mb-6">
            ...
            result of these Legal Terms or your use of the Services. You agree
            that these Legal Terms will not be construed against us by virtue of
          ...
          <h2 className="text-xl font-semibold text-slate-50 mb-2">
            <span className="font-bold">25.</span> CONTACT US
          </h2>
          ...
          <p className="text-slate-100">Atlas OCR</p>
          <p className="text-slate-100">
            Email:{" "}
            <a
              href="mailto:support@atlasocr.com"
